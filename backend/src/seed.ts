...
async function seedTeams() {
  ...
  const teamsData = JSON.parse(
    fs.readFileSync(path.join(__dirname, 'seed-data', 'teams.json'), 'utf-8')
  );
...
async function seedMessages() {
  ...
  const messagesData = JSON.parse(
    fs.readFileSync(path.join(__dirname, 'seed-data', 'messages.json'), 'utf-8')
  );
...
async function seedInsights() {
  ...
  const insightsData = JSON.parse(
    fs.readFileSync(path.join(__dirname, 'seed-data', 'insights.json'), 'utf-8')
  );
