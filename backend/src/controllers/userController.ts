...
import { UserDTO, CreateUserRequest, UpdateUserRequest, usersToDTO } from '../types.js'
...
export class UserController {
   ...
   */
  static async getUserById(id: string): Promise<UserDTO & { teams?: Array<{id: string, name: string, teamRole: string}> } | null> {
   ...
   */
  static async createUser(data: CreateUserRequest): Promise<UserDTO> {
   ...
   */
  static async updateUser(id: string, data: UpdateUserRequest): Promise<UserDTO> {
